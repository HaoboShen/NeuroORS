...
if __name__ == '__main__':
    ...
    lsm_net = LSM(1000, 24, 4, np.float32(np.zeros((1000,24))), np.float32(np.zeros((1000,1000))), alpha=alpha, beta=beta, th=20).to(device)
    lsm_net.load_state_dict(torch.load("lsm_net_diff_data1.pth"))
    lsm_net.eval()
    print(lsm_net)
