...
# 保存到csv
if save_flag == 1:
    peach1_diff.to_csv('peach1_diff_cut.csv')
    peach2_diff.to_csv('peach2_diff_cut.csv')
    apple1_diff.to_csv('apple1_diff_cut.csv')
    apple2_diff.to_csv('apple2_diff_cut.csv')
    orange1_diff.to_csv('orange1_diff_cut.csv')
    orange2_diff.to_csv('orange2_diff_cut.csv')
    air1_diff.to_csv('air1_diff_cut.csv')
    air2_diff.to_csv('air2_diff_cut.csv')
print(air1_diff.shape, air2_diff.shape)
