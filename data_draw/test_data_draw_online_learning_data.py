...
# def plot_combined_data_with_background(data, title, colors, labels, min_span_width=50, font_name='Times New Roman', font_size=20):
...
#     # 画虚线和标注
#     annotations = {
#         407: 'peach essence placed',
#         427: 'peach model placed',
#         624: 'peach essence removed',
#         644: 'peach model removed',
#         1306: 'orange essence placed',
#         1326: 'orange model placed',
#         1519: 'orange essence removed',
#         1539: 'orange model removed',
#     }
...
#     file_paths = {
#         'peach_orange_classification_test': 'E-nose data/peach_orange_ol_test_data_2024-06-28-13-54-15.csv'  # 修改文件路径
#     }
...
def plot_combined_data_with_background(data, title, colors, labels, min_span_width=50, font_name='Times New Roman', font_size=20):
    ...
    ax.set_title(title, fontdict={'family': font_name, 'size': font_size + 4}, pad=10)
...
def main():
    colors = {0: 'lightgreen', 1: 'lightcoral', 2: 'thistle'}
    labels = {0: 'air', 1: 'orange', 2: 'peach'}
    file_paths = {
        'peach_orange_classification_test': 'Recognize data/test_data_0.01_4973_20240710.csv'
    }

    for key in file_paths.keys():
        data = load_and_prepare_data(file_paths[key])
        title = key.replace('_', ' ').title()
        plot_combined_data_with_background(data, title, colors, labels, font_size=20)
