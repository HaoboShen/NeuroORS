...
if __name__ == '__main__':
    ...
    load_model_name = "lsm_net_orange_peach_online_diff.pth"
    save_model_name = time.strftime("lsm_net_orange_peach_oline_backup_%Y-%m-%d-%H-%M-%S.pth", time.localtime())
...
# print("lsm_out:", lsm_out)
    while ser.receive_thread_running:
        ...
        #     print(data_tensor.shape)
            ...
            # torch.save(lsm_net.state_dict(), save_model_name)
